 ...
 * @author apple
 */
public class Abuja extends javax.swing.JFrame {
private final JLabel[] clockLabels;
    /**
     * Creates new form Abuja
     */
    public Abuja() {
        initComponents();
        
        
        setTitle("TIME IN ABUJA RIGHT NOW");
        ...
        clockLabels[0] = createClockLabel("                      THE TIME IN ABUJA", "Africa/Lagos");
    ...
    private JLabel createClockLabel(String cityName, String timeZoneId) {
        ...
        label.setFont(new Font("luminari", Font.BOLD, 35));
    ...
    private void initComponents() {
        ...
        jButton1.setFont(new java.awt.Font("Luminari", 0, 36)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Abuja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
