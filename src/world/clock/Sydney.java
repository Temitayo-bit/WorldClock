 ...
 * @author apple
 */
public class Sydney extends javax.swing.JFrame {
private final JLabel[] clockLabels;
    /**
     * Creates new form Sydney
     */
    public Sydney() {
        initComponents();
        ...
        setTitle("TIME IN SYDNEY RIGHT NOW");
       
        setLocationRelativeTo(null);

        // Create labels for each clock
        clockLabels = new JLabel[1];       
        clockLabels[0] = createClockLabel("                  THE TIME IN SYDNEY", "Australia/Sydney");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sydney.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
