 ...
 * @author apple
 */
public class Chicago extends javax.swing.JFrame {
private final JLabel[] clockLabels;
    /**
     * Creates new form Chicago
     */
    public Chicago() {
        initComponents();
 
        setTitle("TIME IN CHICAGO RIGHT NOW");
        ...
        clockLabels[0] = createClockLabel("                  THE TIME IN CHICAGO", "America/Chicago");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Chicago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
